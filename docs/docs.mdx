...
The SelectStepper component supports all Mantine theme colors. Use the `color` prop to set the LED color:
...
You can customize the appearance of the `SelectStepper` component using the Styles API. This allows you to modify styles for various parts of the component, such as the root, select-stepper, and label.
